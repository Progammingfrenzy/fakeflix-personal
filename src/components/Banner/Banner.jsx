...
import { addRecentlyWatched } from '../../redux/continueWatching';
...
const Banner = ({ type }) => {
	...
	const handlePlayAnimation = event => {
        ...
        const watchedItem = {
            id: finalData?.id,
            media_type: finalData?.media_type || (fallbackTitle ? 'movie' : 'tv'),
            title: fallbackTitle,
            poster_path: finalData?.poster_path,
            backdrop_path: finalData?.backdrop_path,
            timestamp: Date.now()
        };
